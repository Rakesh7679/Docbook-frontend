...
const Doctors = () => {
  ...
  const { doctors } = useContext(AppContext) // Fixed useContext usage
  ...
  useEffect(() => {
    applyFilter(speciality) // Pass speciality to applyFilter
  }, [doctors, speciality])
  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className=' w-auto grid grid-cols-auto gap-4 gap-y-6 '>
          {
