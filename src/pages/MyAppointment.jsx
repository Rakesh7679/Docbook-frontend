      ...
      <div>
        {/* Appointments */}
        {
          appointments.map((item, index) => (
           ...
           {!item.cancelled && item.payment && !item.isCompleted && <button className='sm:min-w-48 py-2 border border-green-500 rounded test-green-500'> Payment done </button>}
            ...
            {item.cancelled && !item.isCompleted && <button className='sm:min-w-48 py-2 border border-red-500 rounded test-red-500'> Appointment cancelled </button>}
            {item.isCompleted && <button className='sm:min-w-48 py-2 border border-green-500 rounded test-green-500'> Appointment completed </button>}
           </div>
            </div>
