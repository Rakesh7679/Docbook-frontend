...
// import newimage from "/src/newImage.jpg";
...
/>
      ...
      <div className="flex items-center gap-4">
        {token && userData ? (
          <div className="flex items-center gap-2 cursor-pointer relative">
            ...
            {showDropdown && ( // Conditionally render dropdown
              <div className="absolute top-12 right-0 text-base font-medium text-gray-600 z-20 bg-stone-100 rounded flex flex-col gap-4 p-4 shadow-lg">
                <p
                  onClick={() => {
                    navigate('my-profile');
        ...
        >
          ...
          <ul className="flex flex-col gap-2 items-center text-lg font-medium mt-5 px-5">
